...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield scp(ssh, local, remote, dotfiles, concurrency, verbose, recursive, rmRemote, exclude);
            ssh.dispose();
        }
        catch (err) {
            core.setFailed(err);
...
function scp(ssh, local, remote, dotfiles = false, concurrency, verbose = true, recursive = true, rmRemote = false, exclude) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            if (isDirectory(local)) {
                ...
                yield putDirectory(ssh, local, remote, dotfiles, concurrency, verbose, recursive, exclude);
            }
            else {
...
function putDirectory(ssh, local, remote, dotfiles = false, concurrency = 3, verbose = false, recursive = true, exclude) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const status = yield ssh.putDirectory(local, remote, {
            ...
            validate: (path) => (!path_1.default.basename(path).startsWith('.') || dotfiles) && !path_1.default.basename(path).startsWith(exclude),
